export const experience = [
  {
    ...
    company: "Sparkout Technologies, Coimbatore",
    period: "Feb 2025 – Present",
    description: [
      "Built scalable frontend applications using React.js, Next.js, Redux, and TypeScript.",
      "Integrated Web3 and fintech workflows with Fireblocks and Primer.io (payment SDK).",
  ...
  },
  {
    ...
    company: "Handbiltapps, Trichy",
    period: "Apr 2023 – Jul 2024",
    description: [
      "Built custom WordPress themes and plugins from scratch, including dynamic content workflows using ACF.",
      "Developed responsive UI features using HTML, CSS, JavaScript, and React.js based on product requirements.",
  ...
  },
  {
    ...
    company: "jZersys Technologies, Bangalore",
    period: "Aug 2022 – Mar 2023",
    description: [
      "Started my development career by building a strong foundation in HTML, CSS, Bootstrap, React, and WordPress.",
  ...
  },
  {
    ...
    description: [
      "Handled insurance operations in a non-voice process with a focus on accuracy and turnaround time.",
      "Processed policy-related records and maintained quality standards across daily operations.",
